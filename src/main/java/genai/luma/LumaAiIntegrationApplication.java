...
public class LumaAiIntegrationApplication {
    ...
    public static void main(String[] args) {
        ...
        String videoPrompt = "A professional business party, featuring diverse, realistic individuals with detailed, lifelike faces, natural expressions, and perfect fashion outfits with various modern styles. Yellow, light-pink, white and blue colored clothes. Bright lighting, high-quality facial details, and modern aesthetics ensure a professional, realistic video output";
        String model = "ray-2";
        ...
        String imagePrompt = "A professional business party, featuring diverse, realistic individuals with detailed, lifelike faces, natural expressions, and perfect fashion outfits with various modern styles. Yellow, light-pink, white and blue colored clothes. Bright lighting, high-quality facial details, and modern aesthetics ensure a professional, photo realistic output";
